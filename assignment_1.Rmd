...
> $\begin{align*}  `r paste0(paste0("t_{ \\hat{ \\beta_{", names(tVector), "} } } & = "), paste0(round(tVector[names(tVector)], 4)), collapse="\\\\")`  
\end{align*}$  
...
`r ifelse(is.logical(reject), ifelse(reject[1], paste0("Ablehnen!"), paste0("Nicht ablehnen.")), paste(reject))`
`r if(is.logical(reject)) ifelse(reject[2], paste0("Ablehnen!"), paste0("Nicht ablehnen."))`
